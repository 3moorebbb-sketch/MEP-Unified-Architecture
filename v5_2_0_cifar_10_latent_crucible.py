...
def print_rigorous_statistics(name, mep_scores, baseline_scores):
    ...
    # Simplified string formatting to prevent parsing errors
    significance_string = "(Significant < 0.05)" if p_val < 0.05 else "(Not Significant)"
    ...
    print(f"Welch's t-test p-value: {p_val:.4e} {significance_string}")
